        ...
        <ul nt-side-navigation class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element" dropdown>
                    <span>
                        <img alt="{{shell.profile.fullName}}" class="img-circle" width="50" height="50" src="{{shell.avatar}}">
                    </span>
            ...
            <li ui-sref-active="active">
                <a ui-sref="index.dashboard"><nt-fa name="th-large"></nt-fa> <span class="nav-label">Dashboard</span></a>
            </li>
            ...
            @if(Auth::user()->is('website_moderator|book_moderator|sa'))
                ...
                <li ng-class="{active: $state.includes('library')}">
                    <a href="#"><nt-fa name="institution"></nt-fa> <span class="nav-label">Bibliotheek</span> <span
                                class="fa arrow"></span></a>
                    <ul class="nav nav-second-level" ng-class="{in: $state.includes('library')}">
                        @if(Auth::user()->is('website_moderator|sa'))
                            <!-- WEBSITES -->
                            <li ui-sref-active="active">
                                <a ui-sref="library.websites"><nt-fa name="globe"></nt-fa> Websites</a>
                            </li>
                            <!-- .WEBSITES -->
                        @endif
                        ...
                        @if(Auth::user()->is('book_moderator|sa'))
                            <!-- BOOKS -->
                            <li ui-sref-active="active">
                                <a ui-sref="library.books"><nt-fa name="book"></nt-fa> Boeken</a>
                            </li>
                            <!-- .BOOKS -->
                        @endif
                    </ul>
